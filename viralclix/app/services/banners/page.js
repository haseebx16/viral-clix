    ...
    <>
      ...
      <div className="min-h-screen two-d-gradient">
        <motion.div
          ...
          viewport={{ once: false }} // Animation will repeat as you scroll
        >
          <img src='/banner-1.jpeg' className='w-96 md:w-[30rem] h-52 md:hover:h-64 duration-300 rounded-lg shadow-green-200 shadow-lg' />
