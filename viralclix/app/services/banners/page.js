        ...
        <div className='flex justify-center items-center flex-col w-full'>
            <div className='text-white text-center mt-12'>
                ...
                <p className='sm:text-2xl text-center text-white'>
                    Get personalized Banners for your projects.
                </p>
                </div>
            </div>
        </div>
