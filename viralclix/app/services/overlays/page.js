    ...
    <>
      ...
      <div className="min-h-screen two-d-gradient">
        <motion.div
          ...
          viewport={{ once: false }} // Animation will repeat as you scroll
        >
        <img src='/overlay.jpeg' className='w-auto h-72 md:hover:h-80 duration-300 rounded-lg shadow-green-200 shadow-lg'/>
        ...
        >
          <p className={`${font2.className} text-white mt-12 text-center text-xl mx-12 max-w-2xl p-4 rounded-md`}>
            ...
            ViralClix is your go-to destination for captivating Overlay artwork that elevates your creative projects. Our skilled artists craft stunning illustrations, character designs, and custom pieces that perfectly align with your vision. With a focus on quality and detail, we transform ideas into eye-catching visuals that make a lasting impact. Partner with us to bring your concepts to life and let your creativity shine!
          </p>
          <img src='/overlay-yellow.jpg' className='w-auto h-72 md:hover:h-80 duration-300 rounded-lg shadow-green-200 shadow-lg'/>
        </motion.div>
      </div>
      <Footer />
    </>
