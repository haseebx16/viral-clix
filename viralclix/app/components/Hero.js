    ...
    >
      <div className='pb-24 w-full'>
        ...
        <div className='flex flex-col sm:flex-row text-white justify-center items-center mt-16'>
          <div className="block max-w-sm p-6 w-80 text-white h-32 hover:bg-green-800 duration-300 hover:text-white bg-opacity-50 bg-black border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mb-4 sm:mb-0 sm:mr-4">
          ...
          <div className="block max-w-sm p-6 w-80 h-32 hover:bg-green-800 duration-300 hover:text-white bg-opacity-50 bg-black border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mb-4 sm:mb-0 sm:mr-4">
