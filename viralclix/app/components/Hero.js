...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[25rem] flex items-center justify-center flex-col overflow-hidden">
      ...
      {/* Content */}
      <div className={`${font2.className} z-10 p-12 md:p-24 flex items-center justify-center flex-col`}>
        <div className="pb-24 w-full">
          ...
          {/* Updated <hr /> to cover 80% width */}
          <hr className="my-4 border-t-4 w-[80%] mx-auto p-0.5 border-gray-400 mt-20 shadow-lg shadow-customGreen-light" />
        </div>

        {/* Sliding Text Section */}
        <motion.div className='gradient-bg w-[80%] rounded-2xl py-12 overflow-hidden mx-auto'>
          <motion.div
            initial={{ x: '100vw' }} // Start off-screen on the right
            animate={{
              x: ['100vw', '0vw', '-100vw'], // Slide across the full screen width
            }}
            transition={{
