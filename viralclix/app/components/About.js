...
const About = () => {
  ...
  return (
    <div className="relative min-h-screen pb-36 flex items-center justify-center flex-col">
      ...
      {/* Content */}
      <div className={`${font2.className} z-10 min-h-screen flex flex-col items-center justify-center`}>
        ...
        >
          <div className={`${font.className} text-yellow-300 text-4xl`}>
            200+{' '}
            <p className={`${font2.className} text-white text-sm w-32 whitespace-nowrap`}>
              Clients Satisfied
            </p>
          </div>
          <div className={`${font.className} text-yellow-300 text-4xl`}>
        ...
        >
          ...
          >
            ...
            <p className="text-lg md:text-xl max-w-xl">
              At ViralClix, we provide comprehensive A to Z graphic design services, catering to all your
              creative needs. Our team specializes in everything from logo creation to 2D, 3D, and digital
              illustrations. We are dedicated to delivering high-quality, custom-designed artworks, ensuring
              each project reflects your vision. Whether it's branding, character design, or creative marketing
              assets, we’ve got you covered. Please note, we do not offer NSFW content, keeping our work
              professional and versatile for all audiences.
            </p>
          </motion.div>
        </motion.div>
      </div>
